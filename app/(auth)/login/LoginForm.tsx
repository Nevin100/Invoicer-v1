        ...
        <div className="text-center mb-8 md:mb-10">
          <Link href="/" className="inline-block mb-5 md:mb-6 group">
            <div className="w-14 h-14 md:w-16 md:h-16 bg-slate-900 rounded-[1.5rem] flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform duration-500">
              <Image src="/favicon.ico" alt="Logo" width={32} height={32} className="brightness-200" />
            </div>
          </Link>
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-100 p-6 md:p-12 rounded-[2rem] md:rounded-[3rem] shadow-2xl shadow-slate-200/50">
          <div className="mb-6 md:mb-8">
            ...
            <p className="text-slate-500 text-sm font-medium mt-1">
              New to the platform?{" "}
              <Link href="/signup" className="text-indigo-600 font-black hover:underline underline-offset-4 transition-all">
                JOIN THE ELITE
              </Link>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6">
            ...
            <div className="space-y-2">
              ...
              />
              {emailError && (
                <p className="text-rose-500 text-[10px] font-black uppercase tracking-tighter">{emailError}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Link href="/forgot" className="text-[10px] font-black text-indigo-500 uppercase tracking-widest hover:text-indigo-700">
                  Lost Key?
                </Link>
              </div>
              ...
              {passwordError && (
                <p className="text-rose-500 text-[10px] font-black uppercase tracking-tighter">{passwordError}</p>
              )}
            </div>
